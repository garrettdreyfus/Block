...
urlpatterns = patterns('',
    ...
    url(r'^school_profile/addSingleClass/$', views.addSingleClass, name='addSingleClass'),
    url(r'^school_profile/addMultipleClasses/$', views.addMultipleClasses, name='addMultipleClasses'),
