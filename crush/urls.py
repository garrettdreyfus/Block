...
urlpatterns = patterns('',
    ...
    url(r'^school_home/addClass/$', views.addClass, name='addClass'),
    url(r'^school_home/addStudents/$', views.addStudents, name='addStudents'),
    url(r'^school_home/run_the_sort/$', views.run_the_sort, name='run_the_sort'),
    ...
    url(r'^school_home/deleted/$', views.deleted, name='deleted'),
    url(r'^school_home/Publish$', views.Publish, name='Publish'),
    url(r'^school_home/edit_class/$', views.edit_class, name='edit_class'),
    url(r'^school_profile/logout_view/$', views.logout_view, name='logout_view'),
    url(r'^school_home/logout_view/$', views.logout_view, name='logout_view'),
    url(r'^userview/logout_view/$', views.logout_view, name='logout_view'),
    url(r'^log_in/$', views.log_in, name='log_in'),
    url(r'^school_home/deadline/$', views.deadline, name='deadline'),
)
